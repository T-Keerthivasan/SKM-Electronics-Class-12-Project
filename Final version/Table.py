...
def create_database():
    ...
    cursor.execute("CREATE DATABASE IF NOT EXISTS TechnoSparkz")

    # Use the created database
    cursor.execute("USE TechnoSparkz")

    return db_connection, cursor

def create_tables(cursor, db_connection):
    ...
    # Commit the changes using the db_connection object
